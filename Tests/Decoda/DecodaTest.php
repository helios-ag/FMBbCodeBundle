...
class DecodaTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetLocale()
    {
        ...
        $this->assertEquals('en', $result->config('locale'));

        $result->setLocale('fr');

        $this->assertEquals('fr', $result->config('locale'));
    }
    ...
    public function getMessage()
    {
        return array(
            ...
            array('foo', null, 'foo', new \DomainException('Localized strings for foo do not exist')),
            array(null, 'foo', 'foo', new \DomainException('Localized strings for foo do not exist')),
